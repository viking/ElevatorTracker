...
public class MainActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            NumberPicker currentFloorView = (NumberPicker) rootView.findViewById(R.id.CurrentFloor);
            currentFloorView.setMinValue(1);
            currentFloorView.setMaxValue(MAX_FLOORS);
            
            NumberPicker targetFloorView = (NumberPicker) rootView.findViewById(R.id.TargetFloor);
